...
func ViewState(firstAttempt int, secondAttempt int, thirdAttempt int) string {
	...
	if secondAttempt == 0 && crossingState {
	...
	} else if secondAttempt == 1 && crossingState {
		fmt.Println("[wolf ---\\ \\corn human/  _________________ / sheep]")
	...
	if secondAttempt == 0 && thirdAttempt == 0 && crossingState {
	...
	} else if secondAttempt == 1 && thirdAttempt == 0 && crossingState {
